package ru.yandex.practicum.sprint13koh34
...
import ru.yandex.practicum.sprint13koh34.databinding.VCatalogItemBinding
...
class CatalogItemViewHolder(
    ...
    fun bind(viewData: CatalogItemViewData) {
        ...
        binding.price.text = "${viewData.item.price / 100} ${Currency.RUB.symbol}/${viewData.item.unit}"
